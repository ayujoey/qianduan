...
(() => {
    var e, t, i, n, o, r, s = {
        ...
        5975: (e, t, i) => {
            ...
            function a(e, t, i, o) {
                var r, s, a, l, c, d, u, p, h, f, m, g, y, v, x, b, w, S, A, T, _, k, C, E, B = o[0], P = o[1], M = o[2], R = Math.hypot(B, P, M);
                            ...
                            n._overlapAxes = function (e, t, i, n) {
                                ...
                                for (l = 0; l < g; l++) {
                                    var x = n[l]
                                        ...
                                        , _ = A;
                                    for (c = 1; c < d; c += 1)
                                        (a = t[c].x * b + t[c].y * w) > T ? T = a : a < S && (S = a);
                                    for (c = 1; c < u; c += 1)
                                        (a = i[c].x * b + i[c].y * w) > _ ? _ = a : a < A && (A = a);
                                    if ((o = (r = T - A) < (s = _ - S) ? r : s) < y && (y = o,
                                        v = l,
                                        o <= 0))
                                        break
                                }
                            ...
                            n.fromVertices = function (e, t, i, n, c, d, u, p) {
                                ...
                                for (h = Boolean(A && A.quickDecomp),
                                    ...
                                    if (y = i[w],
                                        ...
                                        A.makeCCW(T),
                                            !1 !== d && A.removeCollinearPoints(T, d),
                                            !1 !== p && A.removeDuplicatePoints && A.removeDuplicatePoints(T, p);
                                        ...
                                        if (!(f < C.min.y || m > C.max.y) && (!g || !x.isStatic && !x.isSleeping) && c(u.collisionFilter, x.collisionFilter)) {
                                            ...
                                            if (v && 1 === b)
                                                ...
                                                for (var w = b > 1 ? 1 : 0, S = y > 1 ? 1 : 0; S < y; S++)
                                                    for (var A = u.parts[S], T = (p = A.bounds,
                                                        w); T < b; T++) {
                                    ...
                                    if (a.trigger(e, "beforeRender", A),
                                        ...
                                        for (i = 0; i < x.length; i++) {
                                            var _ = x[i]
                                                ...
                                                , E = _.pointA
                                                , B = _.pointB;
                                            k && (E = l.add(k.position, _.pointA)),
                                                C && (B = l.add(C.position, _.pointB)),
                                                E && B && (s.contains(e.bounds, E) || s.contains(e.bounds, B)) && S.push(_)
                                        }
                                    ...
                                    if (h.isActive && !h.isSensor) {
                                        ...
                                        for (y.x = m.position.x - m.positionPrev.x,
                                            ...
                                            var E = A[s]
                                                ...
                                                , U = (D = V < 0 ? 0 : D) * C;
                                            O > U || -O > U ? (o = O > 0 ? O : -O,
                                                (i = h.friction * (O > 0 ? 1 : -1) * a) < -o ? i = -o : i > o && (i = o)) : (i = O,
                                                    o = u);
                                            var X = P * b - M * x
                                                , z = R * b - I * x
            ...
            const o = {
                ...
                , r = e => {
                    ...
                    const A = [{
                        ...
                        y: 273,
                        text: "退出",
                        icon: n.fF ? "/guide/exit.png" : "https://i0.hdslb.com/bfs/activity-plat/static/20220309/00979505aec5edd6e5c2f8c096fa0f62/OfPa9ZyIUb.png"
                    }].map(((e, t) => {
